...
data1 = pd.read_csv('/Users/rahulgupta/Research Project/Research Project Code/L5/L5 Behavior/Model/moonlet_data_dynamic_L5[1].csv')
data2 = pd.read_csv('/Users/rahulgupta/Research Project/Research Project Code/L5/L5 Behavior/MoonletMass/moonlet_orbit_data_Mass_L5[2].csv')
...
data2_L5X = data2["L5 X Position (m)"]
