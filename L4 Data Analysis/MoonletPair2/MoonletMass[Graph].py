...
data1 = pd.read_csv('/Users/rahulgupta/Research Project/Research Project Code/L4/L4 Behavior/MoonletMass/moonlet_data_Mass_L4[3].csv')
dynamic = pd.read_csv('/Users/rahulgupta/Research Project/Research Project Code/L4/L4 Behavior/Model/moonlet_data_dynamic_L4[2].csv')
...
labels = ['Control', 'Moonlet Mass 7e22kg', 'Dynamic Moonlet Pair']
...
plt.title('Moonlet Pair 2 - L4 Position')
