...
data = pd.read_csv('/Users/rahulgupta/Research Project/Research Project Code/L4/L4-Behavior/Model/moonlet_data_dynamic_L4[2].csv')
...
ani.save('lagrange_point_4_animation2.mp4', fps=30)
