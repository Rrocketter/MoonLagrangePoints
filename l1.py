...
for moonlet_mass in moonlet_mass_values:
    ...
    print(f"Lagrange Point L1: {l1} meters")
...
for distance_earth_moon in np.arange(3.84e8, 4.84e8, 1e6):
    # Calculate orbital parameters at Lagrange point L1
    angular_velocity, period, speed = calculate_orbital_parameters(moonlet_mass_1, distance_earth_moon)
    l1 = lagrange_point_l1(moonlet_mass_1, distance_earth_moon)
